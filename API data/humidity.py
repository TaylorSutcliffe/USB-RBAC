...
np.savetxt("humidity_date.csv",date,delimiter=',',fmt='%s')
np.savetxt("humidity_time.csv",time,delimiter=',',fmt='%s')
np.savetxt("humidity_values.csv",values,delimiter=',',fmt='%s')
